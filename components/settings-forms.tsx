...
import { saveCompanionSettings, saveProfile } from "@/app/actions/profile";
import { personalityValues, proactivityValues } from "@/lib/auth/validation";
import { Button, Card, Input } from "@/components/ui";

export function ProfileForm({ initialName = "", initialUsername = "", initialAvatar = "", initialBio = "" }: { initialName?: string; initialUsername?: string; initialAvatar?: string; initialBio?: string }) {
