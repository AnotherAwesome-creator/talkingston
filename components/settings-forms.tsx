...
export function ProfileForm({ initialName = "", initialUsername = "", initialAvatar = "" }: { initialName?: string; initialUsername?: string; initialAvatar?: string }) {
