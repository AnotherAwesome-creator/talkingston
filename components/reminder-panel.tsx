...
type Reminder = { id: string; task_id: string; scheduled_at: string; active: boolean };
...
export function ReminderPanel() {
  ...
  const save = async (event: React.FormEvent) => {
    ...
    setTaskId(""); setDate(""); setTime(""); setMessage("Reminder saved. Delivery is not automated in V1."); await load();
  };
